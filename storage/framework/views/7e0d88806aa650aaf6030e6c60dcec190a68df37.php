    ...
    <table class="min-w-full">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm"><a href=" <?php echo e(route('comments.index', ['id' => $user->id])); ?>" class="bg-green-300 rounded-full py-2 px-6">Comentários (<?php echo e($user->comments->count()); ?>)</a></td>
            </tr>
